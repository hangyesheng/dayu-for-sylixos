class NetworkAPIPath:
    ...
    BACKEND_GET_VISUALIZATION_CONFIG = '/visualization_config/{source_id}'
    BACKEND_POST_VISUALIZATION_CONFIG = '/visualization_config/{source_id}'
...
class NetworkAPIMethod:
    ...
    BACKEND_GET_VISUALIZATION_CONFIG = 'GET'
    BACKEND_POST_VISUALIZATION_CONFIG = 'POST'
